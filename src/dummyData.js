...
export const Posts = [
    ...
    {
        id: 2,
        desc: 'Added mugiwara to the collection. #strawhat #onepiece',
    ...
    {
        id: 3,
        desc: 'Say Hi to jack and jill guys. guess which is which :)',
